...
%     strrep(variableNames{k},'_',' ')),'. N=',num2str(length(yData))]);
title(['7 June 2019 Mount Sinabung Band 14 Temperature vs Elevation. N=',num2str(length(yData))],...
    'FontSize', 14, 'FontName', 'Arial');
% title(sprintf('Scatter Plot of Temperature %s vs Elevation',...
%     strrep(variableNames{k},'_',' ')));
xlabel('Elevation','FontSize', 14, 'FontName', 'Arial');
ylabel('Brightness Temperature (Celsius)','FontSize', 14, 'FontName', 'Arial');
