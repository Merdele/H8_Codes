...
data_08 = pcolormatrix_function('tbb_08',YYYYMM,day);
data_09 = pcolormatrix_function('tbb_09',YYYYMM,day);
data_10 = pcolormatrix_function('tbb_10',YYYYMM,day);
data_11 = pcolormatrix_function('tbb_11',YYYYMM,day);
data_12 = pcolormatrix_function('tbb_12',YYYYMM,day);
data_13 = pcolormatrix_function('tbb_13',YYYYMM,day);
data_14 = pcolormatrix_function('tbb_14',YYYYMM,day);
data_15 = pcolormatrix_function('tbb_15',YYYYMM,day);
data_16 = pcolormatrix_function('tbb_16',YYYYMM,day);
...
Output_Folder = ([Matfile_Data_Folder,'/',Volcano,'_',YYYYMM]);
matfilename = [Volcano,'_',YYYYMM,'_Pcolors.mat'];
